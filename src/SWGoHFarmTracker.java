...
public class SWGoHFarmTracker {
	...
	public static void main(String[] args) {
		...
		// This automatically checks for a progress.txt file in the project directory
		// and imports data if so.
	...
	// This method is used to print out a list of every unit that is available to
	// track.
	...
	// This method utilizes listUnits() and allows the user to modify the values for
	// each requirement.
		...
		while (updating) {
			...
			if (answer.equals("y")) {
				...
				if (reqNum >= 0 && reqNum < unit.numRequirements) {
					...
					System.out.println("That is not a valid requirement number");
				}
			} else {
				updating = false;
			}
